...
//        self.cpfTextField.text = "13374336671"
//        self.birthdatePickerField.pickerView.setDate(Date(timeIntervalSinceReferenceDate: -105829200.0), animated: true)
//        self.birthdatePickerField.text = "25/08/97"
//    }
