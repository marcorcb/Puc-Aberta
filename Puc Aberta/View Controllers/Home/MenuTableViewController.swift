...
class MenuTableViewController: BaseTableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 2:
            ...
            self.present(PAAlertController(titleImage: #imageLiteral(resourceName: "icon_question"), message: "Tem certeza de que deseja fazer logout?",
                                           actions: [cancelAction, confirmAction]), animated: false, completion: nil)
        default:
            break
        }
