...
class ScheduleViewController: BaseViewController {
    ...
    func setup() {
        self.unityPickerField.items = [PAPickerItem(title: "Barreiro", data: "Barreiro"),
                                       PAPickerItem(title: "Betim", data: "Betim"),
                                       PAPickerItem(title: "Contagem", data: "Contagem"),
                                       PAPickerItem(title: "Coração Eucarístico", data: "Coração Eucarístico"),
                                       PAPickerItem(title: "Poços de Caldas", data: "Poços de Caldas"),
                                       PAPickerItem(title: "São Gabriel", data: "São Gabriel")]
    ...
    func setupUnity() {
        let index = self.units.firstIndex { (unit) -> Bool in
        ...
        self.eventPeriodLabel.text = dateFormatter.string(from: unit.schedule.dates.first!) + " a " +
            dateFormatter.string(from: unit.schedule.dates.last!)
...
extension ScheduleViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "eventCell", for: indexPath)
