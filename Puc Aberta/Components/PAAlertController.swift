...
class PAAlertController: UIViewController {
    ...
    func setupAnimation() {
        ...
        self.heightConstraint = NSLayoutConstraint(item: self.alertViewContainer, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 0)
        self.widthConstraint.constant = 0
        self.alertViewContainer.addConstraints([self.heightConstraint])
        
        //        let messageLabelHeightConstraint = NSLayoutConstraint(item: self.messageLabel, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: self.messageLabel.frame.size.height)
        //        self.messageLabel.addConstraint(messageLabelHeightConstraint)
    }
...
extension PAAlertController {
    ...
    fileprivate func setupOverlay() {
        ...
        let tapToDismissGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(backgroundTapHandler))
        self.overlayView.addGestureRecognizer(tapToDismissGestureRecognizer)
        
        let leftConstraint = NSLayoutConstraint(item: self.overlayView, attribute: .left, relatedBy: .equal, toItem: self.view, attribute: .left, multiplier: 1, constant: 0)
        let topConstraint = NSLayoutConstraint(item: self.overlayView, attribute: .top, relatedBy: .equal, toItem: self.view, attribute: .top, multiplier: 1, constant: 0)
        let rightConstraint = NSLayoutConstraint(item: self.overlayView, attribute: .right, relatedBy: .equal, toItem: self.view, attribute: .right, multiplier: 1, constant: 0)
        let bottomConstraint = NSLayoutConstraint(item: self.overlayView, attribute: .bottom, relatedBy: .equal, toItem: self.view, attribute: .bottom, multiplier: 1, constant: 0)
    ...
    fileprivate func setupAlertView() {
        ...
        let centerXConstraint = NSLayoutConstraint(item: self.alertViewContainer, attribute: .centerX, relatedBy: .equal, toItem: self.view, attribute: .centerX, multiplier: 1, constant: 0)
        let centerYConstraint = NSLayoutConstraint(item: self.alertViewContainer, attribute: .centerY, relatedBy: .equal, toItem: self.view, attribute: .centerY, multiplier: 1, constant: 0)
        self.widthConstraint = NSLayoutConstraint(item: self.alertViewContainer, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: Constants.AlertView.width)
        let minimumHeightConstraint = NSLayoutConstraint(item: self.alertViewContainer, attribute: .height, relatedBy: .greaterThanOrEqual, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: Constants.AlertView.minimumHeight)
        ...
        let leftConstraint = NSLayoutConstraint(item: self.alertStackView, attribute: .left, relatedBy: .equal, toItem: self.alertViewContainer, attribute: .left, multiplier: 1, constant: 0)
        let topConstraint = NSLayoutConstraint(item: self.alertStackView, attribute: .top, relatedBy: .equal, toItem: self.alertViewContainer, attribute: .top, multiplier: 1, constant: 0)
        let rightConstraint = NSLayoutConstraint(item: self.alertStackView, attribute: .right, relatedBy: .equal, toItem: self.alertViewContainer, attribute: .right, multiplier: 1, constant: 0)
        let bottomConstraint = NSLayoutConstraint(item: self.alertStackView, attribute: .bottom, relatedBy: .equal, toItem: self.alertViewContainer, attribute: .bottom, multiplier: 1, constant: 0)
    ...
    fileprivate func setupTitleImage() {
        ...
        let centerXConstraint = NSLayoutConstraint(item: imageView, attribute: .centerX, relatedBy: .equal, toItem: containerView, attribute: .centerX, multiplier: 1, constant: 0)
        let topConstraint = NSLayoutConstraint(item: imageView, attribute: .top, relatedBy: .equal, toItem: containerView, attribute: .top, multiplier: 1, constant: 0)
        let bottomConstraint = NSLayoutConstraint(item: imageView, attribute: .bottom, relatedBy: .equal, toItem: containerView, attribute: .bottom, multiplier: 1, constant: 0)
