    ...
    public func mask(string: String?) -> String? {
        ...
        for i in 0..<string.count {
            ...
            if currentCharacter == maskCharacter {
                ...
                while (maskCharacter != JConstants.letterMaskCharacter && maskCharacter != JConstants.numberMaskCharacter) {
                ...
                let isValidLetter = maskCharacter == JConstants.letterMaskCharacter && self.isValidLetterCharacter(currentCharacter)
                let isValidNumber = maskCharacter == JConstants.numberMaskCharacter && self.isValidNumberCharacter(currentCharacter)
